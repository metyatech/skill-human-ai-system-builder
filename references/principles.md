...
Use these principles for every human and AI collaborative system:

- Keep one canonical source of truth.
- Make the AI surface machine-readable and diff-friendly.
...
- Keep the human startup path low-friction.

These principles are universal guidance for this skill, not personal preferences.
